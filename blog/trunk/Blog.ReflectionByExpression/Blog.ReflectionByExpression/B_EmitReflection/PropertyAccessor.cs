...
namespace FastDynamicPropertyAccessor
{
    ...
    public class PropertyAccessor : IPropertyAccessor
    {
        ...
        public PropertyAccessor(Type targetType, string property)
        {
            ...
            PropertyInfo propertyInfo = DeepInterfaceDiscoverage.Find(targetType, property);
        ...
        private static void InitTypes()
        {
            ...
            TYPE_HASH[typeof(sbyte)] = OpCodes.Ldind_I1;
            TYPE_HASH[typeof(byte)] = OpCodes.Ldind_U1;
            TYPE_HASH[typeof(char)] = OpCodes.Ldind_U2;
            TYPE_HASH[typeof(short)] = OpCodes.Ldind_I2;
            TYPE_HASH[typeof(ushort)] = OpCodes.Ldind_U2;
            TYPE_HASH[typeof(int)] = OpCodes.Ldind_I4;
            TYPE_HASH[typeof(uint)] = OpCodes.Ldind_U4;
            TYPE_HASH[typeof(long)] = OpCodes.Ldind_I8;
            TYPE_HASH[typeof(ulong)] = OpCodes.Ldind_I8;
            TYPE_HASH[typeof(bool)] = OpCodes.Ldind_I1;
            TYPE_HASH[typeof(double)] = OpCodes.Ldind_R8;
            TYPE_HASH[typeof(float)] = OpCodes.Ldind_R4;
        }
        ...
        private Assembly EmitAssembly()
        {
            ...
            MethodInfo targetGetMethod = DeepInterfaceDiscoverage.GetMethod(this.mTargetType, "get_" + this.mProperty);
            ...
            if (targetSetMethod != null)
            {
                ...
                if (paramType.IsValueType)
                {
                    ...
                    if (TYPE_HASH[paramType] != null)					//and load
                    {
                        OpCode load = (OpCode)TYPE_HASH[paramType];
                        setIL.Emit(load);
                    }
                    else
                    {
