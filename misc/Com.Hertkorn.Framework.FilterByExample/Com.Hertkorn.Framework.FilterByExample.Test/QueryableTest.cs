...
namespace Com.Hertkorn.Framework.FilterByExample
{
    ...
    public class QueryableTest
    {
        ...
        {
            var filtered = m_exampleQueryable.FilterByExample<TestClass>(null, x => x.TestInt);
        }
        ...
        {
            var filtered = m_exampleQueryable.FilterByExample<TestClass>(m_example, null);
        }
        ...
        {
            var filtered = m_exampleQueryable.FilterByExample<TestClass>(m_example, x => x.TestInt, null, x => x.TestLong);
        }
        ...
        {
            var filtered0 = m_exampleQueryable.FilterByExample<TestClass>(new TestClass("asd", 100, 100, 100));
            var filtered1 = m_exampleQueryable.FilterByExample<TestClass>(m_example);
            var filtered5 = m_exampleQueryable.FilterByExample<TestClass>(new TestClass("test0", 9, 3, 9));
        ...
        {
            var filtered = m_exampleQueryable.FilterByExample<TestClass>(new TestClass("asd", 50, 100, 100), x => x.TestInt, x => x.TestLong, x => x.TestString);
