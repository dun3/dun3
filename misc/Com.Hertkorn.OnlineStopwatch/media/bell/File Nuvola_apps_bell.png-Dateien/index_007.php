...
//JSconfig.registerKey('specialSearchEnhanced', true, ( sse_i18n[wgUserLanguage] || sse_i18n['en'] ) + ':', 8);
...
//
// Import language-specific stylesheet, especially useful for languages like German that have unusual capitalization rules
//
...
var i18n_resize = {
 ...
 'en': 'Resize gallery- and categorywidths to fit screen' // default
};
